...
(function() {
  var Chunk, app, com, config, dolaczGracza, exec, express, fs, help, http, incon, info, io, log, mineflayer, odlaczGracza, opn, players, port, restoreWorld, saveWorld, server, socketInfo, stop, term, vec3, world;
