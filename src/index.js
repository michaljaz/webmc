  ...
  var Chunk, Convert, app, compiler, config, convert, devconfig, express, fs, helmet, io, middleware, mineflayer, opn, port, server, vec3, webpack;
  opn = require("opn");
  fs = require("fs");
  ...
  io.sockets.on("connection", function(socket) {
    var bot, botEventMap, emit, heldItem, i, interval, inv, query, socketEventMap;
