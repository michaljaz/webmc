...
(function() {
  var Chunk, app, com, config, dolaczGracza, exec, express, fs, help, http, incon, info, io, log, mineflayer, odlaczGracza, opn, players, port, restoreWorld, saveWorld, server, socketInfo, stop, term, world;
  ...
  dolaczGracza = function(socketid) {
    ...
    socketInfo[socketid].bot._client.on("map_chunk", function(packet) {
      var bitmap, cell, data, fullChunk;
