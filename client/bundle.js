// Generated by CoffeeScript 2.5.1
  //Bundle.js
var AssetLoader, FPC, FirstPersonControls, InventoryBar, Terrain, TerrainWorker, TextureAtlasCreator, UvManager, al, animate, camera, canvas, cursor, gameState, init, materials, parameters, render, renderer, scene, socket, stats, terrain,
...
UvManager = class UvManager {
  constructor(options) {
    this.width = options.width;
    this.height = options.height;
    this.qx = 1 / this.width;
    this.qy = 1 / this.height;
  }
  ...
  getToxel(x, y) {
    ...
    y -= 1;
    x1 = this.qx * x;
    y1 = 1 - this.qy * y - this.qy;
    x2 = this.qx * x + this.qx;
    y2 = 1 - this.qy * y;
...
Terrain = class Terrain {
  constructor(options) {
    ...
    this.uvm = new UvManager({
      width: this.toxelSize,
      height: this.toxelSize
    });
  }
  ...
  genBlockFace(type, voxel) {
    var blockName, error, toxX, toxY, uv;
    ...
    uv = this.uvm.getToxel(toxX, toxY);
    switch (type) {
      case "pz":
        return [
          {
