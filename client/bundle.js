...
Terrain = class Terrain {
  ...
  setVoxel(voxelX, voxelY, voxelZ, value) {
    var cell, cellId, nei, neiCellId, prevVox, voff;
  ...
  generateCellGeometry(cellX, cellY, cellZ) {
    var _this, addFace, addGeo, blockName, cellGeometry, geo, i, j, k, l, n, normals, o, pos, positions, ref, ref1, ref2, uvs, voxel;
    positions = [];
    normals = [];
    uvs = [];
    _this = this;
    ...
    for (i = l = 0, ref = this.cellSize; (0 <= ref ? l <= ref : l >= ref); i = 0 <= ref ? ++l : --l) {
      for (j = n = 0, ref1 = this.cellSize; (0 <= ref1 ? n <= ref1 : n >= ref1); j = 0 <= ref1 ? ++n : --n) {
        for (k = o = 0, ref2 = this.cellSize; (0 <= ref2 ? o <= ref2 : o >= ref2); k = 0 <= ref2 ? ++o : --o) {
          ...
          if (voxel) {
            if (this.blocks[voxel].isBlock) {
              ...
              blockName = this.blocks[voxel].name;
              geo = this.models[blockName];
              addGeo(geo, pos);
            }
          }
        }
...
init = function() {
  var ambientLight, atlasCreator, blocks, clouds, color, directionalLight, fbxl, geometry, ghast, ghast2, i, inv_bar, l, mat, modelsLoaded, modelsNumber, modelsToLoad, n, o, particles, playerObject, playersx, r, ref, ref1, ref2, s, savedTextures, size, sprite, sprite1, sprite2, sprite3, sprite4, sprite5, t, tekstura, texturex, texturex1, texturex2, tickq, vertices, worldMaterial, x, y, z;
  ...
  for (i = s = 0, ref2 = modelsToLoad.length - 1; (0 <= ref2 ? s <= ref2 : s >= ref2); i = 0 <= ref2 ? ++s : --s) {
    (function() {
      var block;
