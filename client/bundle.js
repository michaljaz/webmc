// Generated by CoffeeScript 2.5.1
  //Bundle.js
var AssetLoader, FPC, FirstPersonControls, InventoryBar, Server, Terrain, TerrainWorker, TextureAtlasCreator, al, animate, camera, canvas, cursor, gameState, init, materials, parameters, render, renderer, scene, server, socket, stats, terrain, worker,
...
InventoryBar = class InventoryBar {
  ...
  setup() {
    var i, k, ref, result;
    result = "";
    for (i = k = 0, ref = this.boxes; (0 <= ref ? k <= ref : k >= ref); i = 0 <= ref ? ++k : --k) {
...
init = function() {
  var ambientLight, atlasCreator, clouds, color, directionalLight, geometry, ghast, ghast2, i, inv_bar, k, l, mat, n, o, particles, playerObject, playersx, ref, ref1, savedTextures, size, sprite, sprite1, sprite2, sprite3, sprite4, sprite5, t, tekstura, texturex, texturex1, texturex2, tickq, vertices, worldMaterial, x, y, z;
  //Terrain worker
  ...
  server.socket.on("firstLoad", function(v) {
...
render = function() {
  var color, h, height, i, k, l, object, pos, rayBlock, ref, ref1, time, width;
